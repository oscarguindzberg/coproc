...
issues](https://github.com/procommerce-io/coproc/issues) in order to learn if the issue is already reported. It could be fixed already. 

Please also check our [FAQ](https://github.com/procommerce-io/coproc/wiki/COPAY---FAQ).
...
We will provide a better channel (like an Coproc email address) so you can send the information. If possible, please
encrypt your emails using GnuPG.

To open an issue go to [Github Issues](https://github.com/procommerce-io/coproc/issues).
