...
[BIP44](https://github.com/bitcoin/bips/blob/master/bip-0044.mediawiki) or [BIP45](https://github.com/bitcoin/bips/blob/master/bip-0045.mediawiki). Wallets created in Coproc v1.2 and forward always use BIP44, all previous wallets use BIP45. Also note that since Coproc version v1.2, non-multisig wallets use address types Pay-to-PublicKeyHash (P2PKH) while multisig wallets still use Pay-to-ScriptHash (P2SH) (key `addressType` at the backup):

| Coproc Version  | Wallet Type   | Derivation Strategy   | Address Type  |
|---|---|---|---|---|
|  <1.2  | All  |  BIP45 | P2SH   |
...
BIP45 note: All addresses generated at BWS with BIP45 use the 'shared cosigner index' (2147483647) so Coproc address indexes look like: `m/45'/2147483647/0/x` for main addresses and `m/45'/2147483647/1/y` for change addresses.
...
Copay depends on [Proccore Wallet Service](https://github.com/procommerce-io/proccore-wallet-service) (PWS) for blockchain information, networking and Copayer synchronization.  A PWS instance can be setup and operational within minutes or you can use a public instance like `https://bws.bitpay.com`.  Switching between BWS instances is very simple and can be done with a click from within Copay.  BWS also allows Copay to interoperate with other wallets like [Proccore Wallet CLI] (https://github.com/procommerce-io/proccore-wallet).
