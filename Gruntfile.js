...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      androidsign: {
        command: 'rm -f cordova/project/platforms/android/build/outputs/apk/android-release-signed-aligned.apk; jarsigner -verbose -sigalg SHA1withRSA -digestalg SHA1 -keystore ../coproc.keystore -signedjar cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk  cordova/project/platforms/android/build/outputs/apk/android-release-unsigned.apk copay_play && ../android-sdk-macosx/build-tools/21.1.1/zipalign -v 4 cordova/project/platforms/android/build/outputs/apk/android-release-signed.apk cordova/project/platforms/android/build/outputs/apk/android-release-signed-aligned.apk ',
        stdin: true,
      },
      desktopsign: {
    ...
    concat: {
      ...
      angular: {
        src: [
          ...
          'angular-proccore-wallet-client/angular-proccore-wallet-client.js'
        ],
    ...
    browserify: {
      dist: {
        files: {
          'angular-proccore-wallet-client/angular-proccore-wallet-client.js': ['angular-proccore-wallet-client/index.js'],
